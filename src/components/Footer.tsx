...
const footerLinks = {
  ...
  Resources: [
    ...
    { label: "Resume", href: "/CVmain.png" },
    { label: "GitHub", href: "https://github.com/Phuoctryhard" },
    { label: "LinkedIn", href: "#" },
  ],
  Services: [
...
const socials = [
  ...
  { Icon: () => <Mail size={14} />, href: "mailto:ngodinhphuoc100@gmail.com", label: "Email" },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-10">
          ...
          <div className="col-span-2 space-y-4">
            <div
              className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[#7c3aed] to-[#a855f7] font-bold text-white text-lg"
            ...
            <p className="text-slate-500 text-xs">© 2024 Ngô Phước. All rights reserved.</p>
          </div>
        ...
        <div className="border-t border-white/[0.05] pt-6 flex items-center justify-between">
          <span className="text-slate-600 text-xs">Let&apos;s Connect</span>
          <div className="flex items-center gap-3">
            {socials.map(({ Icon, href, label }) => (
              <a
                ...
                title={label}
                className="w-8 h-8 glass rounded-lg flex items-center justify-center text-slate-500 hover:text-[#a855f7] transition-colors"
              >
                <Icon />
              </a>
            ))}
